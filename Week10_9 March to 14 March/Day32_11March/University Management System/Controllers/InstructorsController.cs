...
namespace University_Management_System.Controllers
{
    ...
    public InstructorsController(UniversityDbContext context)
		...
		public async Task<IActionResult> Create(Instructor instructor)
		{
			...
			ViewBag.DepartmentId = new SelectList(_context.Departments, "DepartmentId", "Name", instructor.DepartmentId);
			return View(instructor);
		}
		...
		public async Task<IActionResult> Edit(int? id)
		{
			...
			ViewData["DepartmentId"] =
				new SelectList(_context.Departments, "DepartmentId", "Name", instructor.DepartmentId);
